...
config.vm.define "repo" do |repo|
  ...
  repo.vm.provision :shell, :inline => "yum install https://dl.fedoraproject.org/pub/epel/epel-release-latest-9.noarch.rpm -y; sudo yum install -y python3-pip python3-devel httpd vsftpd createrepo", run: "always"
...
config.vm.define "node2" do |node2|
  node2.vm.box = "jithu/rhel9-node"
#  node2.vm.hostname = "node2.repo.example.com"
...
config.vm.define "node3" do |node3|
  node3.vm.box = "jithu/rhel9-node"
#  node3.vm.hostname = "node3.repo.example.com"
...
config.vm.define "node4" do |node4|
  node4.vm.box = "jithu/rhel9-node"
#  node4.vm.hostname = "node4.repo.example.com"
...
config.vm.define "control" do |control|
  control.vm.box = "jithu/rhel9-node"
#  control.vm.hostname = "control.repo.example.com"
